          ...
          <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
            <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Keeping happy, loved pets with their guardians</h1>
...
const stats = [
  { label: 'Food donated to other pet food banks/rescues across Western Canada', value: '500,000 lbs' },
  { label: 'Volunteers work across provincial borders to ensure no pet goes hungry', value: '100+ Volunteers' },
  { label: 'Meals provided in just three years', value: '2.4+ Million' },
]
const values = [
  {
    name: 'Be world-class',
